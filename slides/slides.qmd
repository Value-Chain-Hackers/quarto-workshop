...
[^4]: For more info about replacing Rmarkdown with quarto, you can refer to [these FAQs on quarto's webiste](https://quarto.org/docs/faq/rmarkdown.html) and Yihui Xie’s blog post [With Quarto Coming, is R Markdown Going Away? No](https://yihui.org/en/2022/04/quarto-r-markdown/)
